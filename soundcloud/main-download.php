...
function getClientIdFromAPI() {
    ...
    // Extract base path (remove /wp-content/themes/sound-cloud-theme/soundcloud/main-download.php)
    $basePath = str_replace('/wp-content/themes/sound-cloud-theme/soundcloud/main-download.php', '', $script);
    $basePath = str_replace('/soundcloud/main-download.php', '', $basePath);
